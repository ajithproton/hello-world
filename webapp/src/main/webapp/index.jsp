...
<title>CodePen - SVG Rainbow Rocket Man</title>
...
function createJets() {
  ...
  //jet bubbles
  for (var i = 0; i < jetBubbles.length; i++) {if (window.CP.shouldStopExecution(0)) break;
    var jb = jetBubbles[i];
  ...
  //speed lines
  window.CP.exitedLoop(0);for (var i = 0; i < 7; i++) {if (window.CP.shouldStopExecution(1)) break;
  ...
  //stars
  window.CP.exitedLoop(1);for (var i = 0; i < 7; i++) {if (window.CP.shouldStopExecution(2)) break;
